...
static const char qt_meta_stringdata_SceneArea[] = {
    "SceneArea\0\0startPolygon()\0setCurrentTool(int)\0"
    "setPenStyle(int)\0color\0_saveColor(QColor)\0"
    "_saveBrushColor(QColor)\0"
};
...
void SceneArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->startPolygon(); break;
        case 1: _t->setCurrentTool((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->setPenStyle((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->_saveColor((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        case 4: _t->_saveBrushColor((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        default: ;
        }
    }
}
